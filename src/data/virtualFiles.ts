...
export const virtualFiles: Record<string, VirtualFileDefinition> = {
  ...
  'investigation-backup-07': simple('investigation-backup-07', '调查备份_07.txt', 'text', '周寻个人文件', 'incident/0616里有一条完整时间线。\n\n沈栀最后进入了旧实验楼三层。\n\n如果记录没有被再次修改，\n这里应该能告诉我她后来去了哪里。'),
  'investigation-backup-07-final': simple('investigation-backup-07-final', '调查备份_07.txt', 'text', '周寻个人文件', '我还原了六月十六日。\n\n沈栀在晚上七点二十一分进入旧实验楼。\n\n她带着CAM-07，经过广播设备室，最后到了三层设备间。\n\n十点十九分，录音里出现门锁和人声。\n\n十点二十一分，设备间与封闭通道被ADMIN_03权限锁定。\n\n十点二十八分，CAM-07记录到求助、撞击和设备失稳。\n\n十点三十一分，封闭通道的紧急按钮已经被按下。\n\n校园安保看到了信号，但他们没有立即叫救护车。\n\n十四分三十四秒后，外部急救才被呼叫。\n\n沈栀在十一点十六分被送到急救中心。\n\n十一点五十八分，她抢救无效死亡。\n\n第二天早上，校内事件被改写成校外个人意外。\n\n她的名字被从班级名单中删除。\n\nTERM-OLD-03被登记停用，CAM-07被标记为未归还，SYS-0616关闭了公开入口。\n\n沈栀没有退学，也没有转学。\n\n她死在六月十六日那天。\n\n学校删除的不是一个离校学生，是一个已经无法再为自己说话的人。\n\n周寻后来找到了这些记录。他知道沈栀发生了什么。\n\n但他又去了哪里？\n\n下一步：还原九月十四日最后一次完整会话。'),
  'investigation-backup-08': simple('investigation-backup-08', '调查备份_08.txt', 'text', '周寻个人文件', '九月十四日最后一次完整会话，\n并不是一个人从头到尾完成的。\n\n零点零二分之前，\n是周寻。\n\n之后，\n有人借用了他的账号。'),
  'investigation-backup-08-final': simple('investigation-backup-08-final', '调查备份_08.txt', 'text', '周寻个人文件', '我还原了九月十四日最后一次会话。\n\n晚上十一点四十八分，周寻本人登录了TERM-OLD-03。\n\n他创建草稿，移除常用设备，导出ARCHIVE_0616，写下“不要从系统里找我”，并建立了一组验证任务。\n\n零点零一分，外部导出完成。\n\n零点零二分，本地会话中断。\n\n之后的操作不再属于周寻。\n\n零点零三分，ADMIN_03从信息中心建立代理会话。\n\n零点零四分，草稿被加入追踪标记。\n\n零点零九分，系统查到了林默。\n\n零点十一分，林默被加入监测队列。\n\n前几章逐步开放的部分资料，是周寻提前留下的验证任务。\n\n但草稿修改、重新登录和对林默的监测，来自管理员代理。\n\n顾言在学校东门外见过周寻。\n\n他当时清醒，能够自己行走，并安排顾言把文件袋送出学校。\n\n三天后，外部节点收到一条有效签名消息：\n\n我已经离开。\n\n不要回复。\n\n不要找我。\n\n周寻还活着。\n\n他没有退学。\n\n他逃离了学校。\n\n而那份退学证明，是在他离开之后，由ADMIN_03权限签发的。\n\n证明里没有申请，没有学生确认，也没有监护人确认。\n\n最后一份原始记录，就在这张证明的签发链里。\n\n下一步：证明这份退学证明从一开始就是假的。'),
}
