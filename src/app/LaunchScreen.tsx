  ...
  return (
    <main className="launch-screen">
      <section className="launch-card" aria-labelledby="game-title">
        ...
        {state.triggeredEvents.includes('chapter_four_completed')
          ? <div className="chapter-complete-stamp">第四章《权限不足》已完成</div>
          : state.triggeredEvents.includes('chapter_four_started') && <div className="chapter-complete-stamp">第四章《权限不足》调查中</div>}
        {state.triggeredEvents.includes('chapter_five_completed')
          ? <div className="chapter-complete-stamp">第五章《最后登录》已完成</div>
          : state.triggeredEvents.includes('chapter_five_started') && <div className="chapter-complete-stamp">第五章《最后登录》调查中</div>}
        {state.triggeredEvents.includes('chapter_six_completed')
          ? <div className="chapter-complete-stamp">第六章《终端03》已完成</div>
          : state.triggeredEvents.includes('chapter_six_started') && <div className="chapter-complete-stamp">第六章《终端03》调查中</div>}
        ...
        {state.triggeredEvents.includes('chapter_nine_completed')
          ? <div className="chapter-complete-stamp">第九章《最后一个账号》已完成</div>
          : state.triggeredEvents.includes('chapter_nine_started') && <div className="chapter-complete-stamp">第九章《最后一个账号》调查中</div>}
